...
class ENGINE_API UInstancedStaticMeshComponent : public UStaticMeshComponent
{
	...
	/** The Max interval can be generated links */
	UPROPERTY(EditAnywhere, Category = Cluster)
	int32 InstanceMaxInterval;

	/** The Min Linked Num for the center point */
	UPROPERTY(EditAnywhere, Category = Cluster)
	int32 InstanceMinPts;
...
public:
	...
	TSharedPtr<TArray<FGpuDrivenCluster>, ESPMode::ThreadSafe> GpuDrivenCluster; //Release On RenderThread
...
protected:
	...
	virtual void BuildGpuDrivenCluster();
	//@StarLight code - END GPU-Driven, Added by yanjianhong
